...
class GeneralNote(genanki.Note):
    model = genanki.Model(
        2617295532,
        "General Model",
        fields=[{"name": "Noun"}, {"name": "English"}, {"name": "German"}],
        templates=[
            {
                "name": "General_Card",
...
class VerbNote(genanki.Note):
    model = genanki.Model(
        1607492519,
        "Verb Model",
        fields=[{"name": "Verb"}, {"name": "English"}, {"name": "Conjugation"}],
        templates=[
            {
                "name": "Verb_Card",
