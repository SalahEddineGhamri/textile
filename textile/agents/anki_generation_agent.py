...
from textile.anki import AnkiGenerator, VerbNote, NounNote, GeneralNote
from textile.config import INPUT_PATH, ANKI_PATH

# TODO turn caches into singeltons
from textile.tables import NOUN_CACHE
from textile.tables import VERBS_MEANING_CACHE, VERBS_CONJUGATION_CACHE
from textile.tables import ADJECTIVES_CACHE
from textile.tables import ADVERBS_CACHE
from textile.tables import PREPOSITIONS_CACHE
from textile.agents import split_hyphenated_string
